...
public class ProductController {
    ...
    public String getproductCates(Model model) {
        ...
        String mystr = "";
        JSONObject result = JSONObject.fromObject(Constant.getInterface(Constant.PRODUCT_CATES, mystr, arr));
    ...
    public String getProducts(Model model, HttpServletRequest request) {
        ...
        JSONObject info = JSONObject.fromObject(Constant.getInterface(Constant.PRODUCTS, mystr, arr));
    ...
    public String getProductDetail(@PathVariable("productDetail") String productDetail, Model model) {
        ...
        JSONObject productInfo = JSONObject.fromObject(Constant.getInterface(Constant.PRODUCT_DETAIL, mystr, arr));
